...
public partial class GridComponent : ComponentBase, IDisposable
{
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        ...
        await _jsRuntime.InvokeVoidAsync(Configuration.JsBlazorUiNamespace + ".Grid.initializeTable", _selfRef, _tableRef);
    }
    ...
    {
        await _jsRuntime.InvokeVoidAsync(Configuration.JsBlazorUiNamespace + ".Grid.deselectAllRow", _tableRef);
    }
    ...
    protected virtual async Task OnRowClick(MouseEventArgs args, RgfDynamicDictionary rowData, int rowIndex)
    {
        ...
        if (!_isDblClick)
        {
            ...
            await _jsRuntime.InvokeVoidAsync(Configuration.JsBlazorUiNamespace + ".Grid.selectRow", _rowRef[rowIndex], rowIndex);
